    ...
    {toDash ? <Redirect to = "/me" /> : null}
      ...
      <div className="page-header clear-filter" filter-color="blue">
        <div
          ...
          style={{
            backgroundImage: "url(" + require("assets/img/wait.png") + ")"
          }}
        ></div>
        <div className="content" style={ { marginBottom: -100 } }>
          <Container>
            <Col className="m-auto" md="7">
              <p className="text-center" style={ { paddingTop:80,fontWeight: 'bold',fontSize: 50 } }>Please wait for a <span style={ { color: '#ff6c31' } }>Response</span></p>
              <p>Your application now has been shifted to the concerned department. You can check your application status in you association dashboard.</p>
            </Col>
          </Container>
        </div>
