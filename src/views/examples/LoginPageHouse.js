...
function onSubmito(event){
    ...
    fetch('https://againbackend.herokuapp.com/user/loginowner', {
      method: 'POST',
            ...
            <Col className="ml-auto mr-auto" md="4">
              <Card className="card-login card-plain">
                <Form action="" className="form" method="" onSubmit = {onSubmito}>
                  ...
                  <p className="text-center" style={ { fontWeight: 'bold',fontSize: 30 } }><span style={ { color: '#ff6c31' } }>House donaters</span> space</p>
                  <CardBody>
                    <InputGroup
                      className={
                        "no-border input-lg" +
                    ...
                    >
                      ...
                      <Input
                        placeholder="House holder E-mail..."
                        type="text"
			...
			//value={objLogin.password}
                  ...
                  <div className="pull-left">
                    <h6>
                      ...
                      >
                        You are an association a house donater and not registered yet
                      </a>
                    </h6>
                  </div>
                  <Button
