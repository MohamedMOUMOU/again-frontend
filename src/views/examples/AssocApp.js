  ...
  return (
    ...
    {toDash ? <Redirect to = "/me" /> : null}
      ...
      <div className="page-header clear-filter" filter-color="blue">
        ...
        ></div>
        <div className="content" style={ { marginTop: 170 } }>
          <Container>
            <Col className="ml-auto mr-auto" md="4">
              <Card className="card-login card-plain">
                <Form action="" className="form" method="" onSubmit = {onSubmito}>
                  ...
                  <p className="text-center" style={ { fontWeight: 'bold',fontSize: 30 } }><span style={ { color: '#ff6c31' } }>Association</span> application</p>
                  <CardBody>
                    <InputGroup
                      className={
                        "no-border input-lg" +
                    ...
                    >
                      ...
                      <Input
                        placeholder="number of people able to take care of"
                        name="password"
                        label="Password"
